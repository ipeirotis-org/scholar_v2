...
--
-- Builds quantile breakpoints from the pre-computed ranked_author_pip_scores_current_table
-- which already has pip_auc_score for every author. No need to recompute AUC.
--
...
--
-- PREREQUISITE: ranked_author_pip_scores_current_table must be materialized first
...
SELECT DISTINCT * FROM (
  ...
  FROM (
    ...
    FROM `scholar-version2.statistics.ranked_author_pip_scores_current_table`
