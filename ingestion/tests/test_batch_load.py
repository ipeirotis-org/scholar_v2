...
from ingestion.batch_load import (
    archive_files,
    cleanup_temp_file,
    iter_gcs_files,
    load_to_bigquery,
...
class TestIterGcsFiles:
    @mock.patch("ingestion.batch_load._get_storage_client")
...
class TestLoadToBigquery:
    @mock.patch("ingestion.batch_load._get_bigquery_client")
...
class TestProcessBatch:
    @mock.patch("ingestion.batch_load.cleanup_temp_file")
    @mock.patch("ingestion.batch_load.archive_files")
    @mock.patch("ingestion.batch_load.load_to_bigquery", return_value=True)
    @mock.patch("ingestion.batch_load.upload_ndjson", return_value="gs://b/temp.ndjson")
    @mock.patch("ingestion.batch_load.move_to_dead_letter")
    ...
    @mock.patch("ingestion.batch_load.cleanup_temp_file")
    @mock.patch("ingestion.batch_load.upload_ndjson")
    @mock.patch("ingestion.batch_load.move_to_dead_letter")
    ...
    @mock.patch("ingestion.batch_load.cleanup_temp_file")
    @mock.patch("ingestion.batch_load.archive_files")
    @mock.patch("ingestion.batch_load.load_to_bigquery", return_value=False)
    @mock.patch("ingestion.batch_load.upload_ndjson", return_value="gs://b/temp.ndjson")
...
class TestProcessEntity:
    @mock.patch("ingestion.batch_load.process_batch")
    @mock.patch("ingestion.batch_load.iter_gcs_files")
...
class TestBatchLoadEntryPoint:
    @mock.patch("ingestion.batch_load.process_entity")
    def test_default_params(self, mock_process):
        from ingestion.batch_load import batch_load_gcs_to_bq
    ...
    @mock.patch("ingestion.batch_load.process_entity", side_effect=Exception("boom"))
