...
class TestGetStaleAuthors:
    @mock.patch("v3.refresh.bigquery_client._query")
    def test_returns_scholar_ids(self, mock_query):
        ...
        from v3.refresh.bigquery_client import get_stale_authors
...
class TestGetErrorAuthors:
    ...
    def test_returns_scholar_ids(self, mock_query):
        ...
        from v3.refresh.bigquery_client import get_error_authors
...
class TestGetCoauthorsToAdd:
    ...
    def test_returns_scholar_ids(self, mock_query):
        ...
        from v3.refresh.bigquery_client import get_coauthors_to_add
...
class TestAuthorExists:
    ...
    def test_exists(self, mock_query):
        ...
        from v3.refresh.bigquery_client import author_exists
