...
class TestRefreshStale:
    @mock.patch("v3.refresh.main.refresh_service")
    def test_success(self, mock_service):
        ...
        from v3.refresh.main import refresh_stale
...
class TestRefreshErrors:
    ...
    def test_success(self, mock_service):
        ...
        from v3.refresh.main import refresh_errors
...
class TestExpandCoauthors:
    ...
    def test_success(self, mock_service):
        ...
        from v3.refresh.main import expand_coauthors
...
class TestFetchAuthor:
    ...
    def test_success(self, mock_service):
        ...
        from v3.refresh.main import fetch_author
...
class TestFetchAuthors:
    ...
    def test_comma_separated(self, mock_service):
        ...
        from v3.refresh.main import fetch_authors
...
class TestValidateScholarId:
    def test_valid_ids(self):
        from v3.refresh.main import _validate_scholar_id
...
class TestGetIntParam:
    def test_from_args(self):
        from v3.refresh.main import _get_int_param
