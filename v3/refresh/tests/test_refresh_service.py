...
class TestRefreshStaleAuthors:
    @mock.patch("v3.refresh.refresh_service.task_enqueuer")
    @mock.patch("v3.refresh.refresh_service.bq")
    def test_finds_and_enqueues(self, mock_bq, mock_enqueuer):
        ...
        from v3.refresh.refresh_service import refresh_stale_authors
...
class TestRefreshErrorAuthors:
    ...
    def test_finds_and_enqueues(self, mock_bq, mock_enqueuer):
        ...
        from v3.refresh.refresh_service import refresh_error_authors
...
class TestExpandCoauthors:
    ...
    def test_finds_and_enqueues(self, mock_bq, mock_enqueuer):
        ...
        from v3.refresh.refresh_service import expand_coauthors
...
class TestFetchAuthor:
    ...
    def test_enqueue_new_author(self, mock_bq, mock_enqueuer):
        ...
        from v3.refresh.refresh_service import fetch_author
...
class TestFetchAuthors:
    ...
    def test_enqueues_all(self, mock_enqueuer):
        ...
        from v3.refresh.refresh_service import fetch_authors
