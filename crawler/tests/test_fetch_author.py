...
from crawler.fetch_author import v3_fetch_author as handle
...
class TestHandleFetchAuthor:
    ...
    @mock.patch("crawler.fetch_author.author_blob_path", return_value="authors_json/2026/03/19/abc.json")
