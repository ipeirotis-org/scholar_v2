...
from crawler.gcs_writer import upload_json, author_blob_path, publication_blob_path
...
class TestUploadJson:
    @mock.patch("crawler.gcs_writer._get_client")
    ...
    @mock.patch("crawler.gcs_writer.time.sleep")
    @mock.patch("crawler.gcs_writer._get_client")
